"""Inherited safety regressions plus v1 model provenance."""
...
def test_v1_model_records_sequence_state_ranker():
...
def test_v1_runtime_cleanly_omits_rejected_numeric_model():
