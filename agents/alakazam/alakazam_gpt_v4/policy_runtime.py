...
class HybridRanker:
    """v31 safety shell with v1 ranker and v4 multi-teacher type ensemble."""
    ...
    def __init__(
        ...
        self.enable_override = os.environ.get(
            "ALAKAZAM_ML_V4_ENABLE_OVERRIDE",
            os.environ.get(
                "ALAKAZAM_ML_V3_ENABLE_OVERRIDE",
                os.environ.get(
        ...
        self.enable_memory = os.environ.get(
            "ALAKAZAM_ML_V4_ENABLE_MEMORY",
            os.environ.get(
                "ALAKAZAM_ML_V3_ENABLE_MEMORY",
                os.environ.get(
    ...
    def _type_meta_row(
        ...
        """Build the v3 rich action-type representation.

        The prefix is byte-for-byte compatible with v2's 356-value row.
        v3 then appends per-type route, lethal, hand-delta, draw, and option-
        ordering summaries.  Every value is computed from public runtime
        features and the already-deployed v1 candidate scores.
        """
        ...
        # v3 suffix: exact order matches research/rich_meta arrays.
        for action_type in range(12):
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {
            **dict(self.diag),
            "runtime_scope": "v4_rmy_blended_type_gate_plus_v1_ranker_v31_safety",
