...
def main():
    ...
    spec=json.load(open('/mnt/data/v3_work/alakazam_gpt_v3/type_runtime_spec.json'))
    model=json.load(open('/mnt/data/v3_work/alakazam_gpt_v3/type_model.json'))
    cols=np.asarray(model['cols'],np.int32)
    booster=lgb.Booster(model_file='/mnt/data/v1_work/results/v1_baseline_lgb.txt')
