...
KEY_CARD_IDS = [5, 13, 19, 66, 104, 112, 140, 305, 343, 648, 741, 742, 743, 1079, 1081, 1086, 1097, 1129, 1152, 1182, 1197, 1225, 1231, 1266]
...
def option_features(
    ...
    if rare_candy_route:
        ...
        hand_cost = 2
        evolution_draw = 3
    post_hand_count = max(0, int(out["self_hand_count"]) - hand_cost + evolution_draw)
    ...
    out.update({
        ...
        "candidate_net_hand_delta": evolution_draw - hand_cost,
