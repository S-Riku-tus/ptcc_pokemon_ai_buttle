...
# Both the new-teacher and fixed old-teacher holdouts improved only for bench
# decisions. Attack and evolution remain deterministic until a later model
# clears their own action-level gates.
ML_ALLOWED_ACTIONS = {"bench"}
...
class HybridRanker:
    ...
    def __init__(self, attacks: dict[int, dict[str, Any]] | None = None, threshold: float = 0.55):
        ...
        override = os.environ.get(
            "ALAKAZAM_ML_V14_ENABLE_OVERRIDE",
            os.environ.get(
                "ALAKAZAM_ML_V13_ENABLE_OVERRIDE",
                os.environ.get(
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {
            **dict(self.diag),
            "runtime_scope": "shadow_guarded_semantic_bench_v14_rules",
