...
def test_v14_end_loses_to_protected_powerful_hand_fallback():
    ...
    assert obj._score_attack(attack) == 500
...
def test_v14_attached_mist_releases_reservation_and_plays_hammer():
    ...
    assert obj._score_play_trainer(h.Card(policy.C.ENHANCED_HAMMER)) == 17000
