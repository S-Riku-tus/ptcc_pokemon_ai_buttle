...
def _cards():
    return [
        ...
        CardData(648, attacks=[937], stage2=True, ex=True, name="Marnie's Grimmsnarl ex"),
    ...
    return [
        ...
        *[AttackData(i, [EnergyType.COLORLESS]) for i in range(500, 508)],
        ...
        AttackData(716, [EnergyType.COLORLESS],
                   ...
                   damage=10),
        AttackData(937, [EnergyType.COLORLESS, EnergyType.COLORLESS],
                   text="This attack also does 30 damage to 1 of your opponent's Benched Pokemon.",
                   damage=180),
    ]
...
def test_v11_fez_does_not_sink_two_more_energy_into_a_speculative_route():
    policy = load_policy()
    fez = Pokemon(policy.C.FEZANDIPITI_EX, hp=210, maxHp=210,
                  energies=[EnergyType.PSYCHIC])
    articuno = Pokemon(policy.ROCKET_ARTICUNO_ID, hp=110, maxHp=110, playerIndex=1)
