...
# v18 preserves v17's two scopes that cleared accepted-action holdouts and a
...
class HybridRanker:
    ...
    def __init__(self, attacks: dict[int, dict[str, Any]] | None = None, threshold: float = 0.55):
        ...
        # This inherited v15 scope passed its live gate and is on by default. Use the
        # versioned flag to disable it explicitly for deterministic A/B tests.
        override = os.environ.get(
            "ALAKAZAM_ML_V18_ENABLE_OVERRIDE",
            os.environ.get(
                "ALAKAZAM_ML_V17_ENABLE_OVERRIDE",
                os.environ.get("ALAKAZAM_ML_V15_ENABLE_OVERRIDE", "1"),
            ),
        )
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {
            **dict(self.diag),
            "runtime_scope": "live_guarded_bench_and_evolution_target_v18_route",
