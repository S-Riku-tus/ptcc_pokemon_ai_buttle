...
def test_v30_ml_scope_is_memory_first_v29_residual_and_safety_guarded():
    ...
    assert 'ALAKAZAM_ML_V30_ENABLE_OVERRIDE", "1"' in source
    ...
    assert 'ALAKAZAM_ML_V30_THRESHOLD", "0.20"' in main_source
