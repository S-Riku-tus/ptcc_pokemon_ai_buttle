...
class HybridRanker:
    """Lossless replay memory plus the v31 two-ranker Majkel ensemble."""
    ...
    def __init__(
        ...
        self.enable_override = (
            os.environ.get("ALAKAZAM_ML_V31_ENABLE_OVERRIDE", "1") == "1"
        )
        self.enable_memory = (
            os.environ.get("ALAKAZAM_ML_V31_ENABLE_MEMORY", "1") == "1"
        )
        ...
        for attribute, artifact in (
            ...
            ("numeric_model", "ranker_numeric_model.json"),
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {
            **dict(self.diag),
            "runtime_scope": (
                "v31_exact_memory_plus_majkel_two_ranker_ensemble"
            ),
        ...
        *,
        ...
        try:
            ...
            numeric_weight = float(
                self.numeric_model.get("ensemble_weight", 1.3)
            )
            scores = [
