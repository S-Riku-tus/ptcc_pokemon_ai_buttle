...
R=Path('/mnt/data/v36_work/rich_meta');OUT=Path('/mnt/data/v37_work/experts');OUT.mkdir(exist_ok=True)
...
cols=np.array(json.load(open('/mnt/data/v36_work/alakazam_ml_v36/type_model.json'))['cols'],np.int32)
