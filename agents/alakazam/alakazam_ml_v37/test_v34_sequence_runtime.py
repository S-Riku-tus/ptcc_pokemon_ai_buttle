...
def test_v34_sequence_state_starts_empty_and_uses_missing_sentinel():
...
def test_v34_record_choice_updates_previous_action_and_counts():
    runtime = HybridRanker()
...
def test_v34_new_turn_resets_only_same_turn_index():
    runtime = HybridRanker()
...
def test_v34_compact_model_metadata_matches_runtime_contract():
