...
def _cards():
    return [
        ...
        CardData(675, attacks=[], skills=[Skill(
            "Prevent all effects of attacks done to your Team Rocket's Pokemon."
        )], name="Team Rocket's Articuno"),
        CardData(678, attacks=[983], stage1=True, ex=True, name="Team Rocket's Spidops"),
        ...
        CardData(648, attacks=[508], stage1=True),
...
def _attacks():
    return [
        ...
        *[AttackData(i, [EnergyType.COLORLESS]) for i in range(500, 509)],
...
def test_deck_is_v6_sixty_cards():
    policy = load_policy()
...
if __name__ == "__main__":
    ...
    for test in tests:
        test()
    print(f"{len(tests)} v6 runtime logic tests passed")
