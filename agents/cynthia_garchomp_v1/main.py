# cynthia_garchomp_v1 - adapted from the public repo wmh/ptcg-abc
# (agents/garchomp GarchompPolicy + agents/_base/policy_base.py), a pilot
# divergence-mined against ladder top-100 player nasuo445 (12,693 MAIN
# decisions). See STRATEGY.md for meta rationale and local benchmarks.
