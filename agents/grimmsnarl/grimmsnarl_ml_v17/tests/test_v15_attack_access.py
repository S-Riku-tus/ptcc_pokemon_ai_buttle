...
# ----- artifacts ------------------------------------------------------------
def test_v17_keeps_v16s_file_scope_against_v15() -> None:
    """v15's safety argument, re-asserted after v17 completes PRESERVE.
    ...
    assert metadata["name"] == "grimmsnarl_ml_v17"
