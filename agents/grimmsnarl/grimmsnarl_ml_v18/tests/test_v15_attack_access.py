...
# ----- artifacts ------------------------------------------------------------
def test_v18_keeps_v17s_model_deck_and_attack_access_against_v15() -> None:
    """v15's safety argument, re-asserted after the v18 mirror audit.
    ...
    assert metadata["name"] == "grimmsnarl_ml_v18"
