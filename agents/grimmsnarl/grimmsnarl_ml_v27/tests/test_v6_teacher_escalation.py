...
def test_shipped_mode_is_the_one_the_results_report_measured() -> None:
    assert ml_runtime.ESCALATION_MODE == "class"
    assert ml_runtime.ESCALATION_TEACHER_TEAM == 16371703


def test_v22_deployed_model_is_globally_pinned_to_the_elite() -> None:
    """v22 deliberately makes the old class escalation the global policy."""
