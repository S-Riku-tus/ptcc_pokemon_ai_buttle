...
# "off"     - v5 exactly.
# v25 deliberately disables the legacy Froslass class escalation.  With the
# v22 model it was inert because both the global pin and escalation used code
# 0.  The AlphaTCG model is code 3, so leaving ``class`` enabled would silently
# splice the observationally-refuted v24-era lever back into the new policy.
ESCALATION_MODE = "off"
