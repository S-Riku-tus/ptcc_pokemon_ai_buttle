...
最終レートのメモは `docs/ALAKAZAM_RATING_LOG.md` に分離して残しています。v1=845.7、v2=855.4、v3=850.3、v4=724.8、v5=750.5 です。v4は実ラダー上では明確な退行、v5はそこからの部分回復ですが、まだ v1-v3 の強度帯には戻っていません。したがって、v5以降も v2 または v3 を骨格にしつつ、v4/v5 ログで確認できた修正点を選択的に移植する方針です。
